...
const iRobotSDK = proxyquire('../lib/v1/local', {
...
describe('dorita980 local instance', () => {
  ...
  it('should require password', () => {
    expect(function () {
      let viaLocal = new iRobotSDK('myblid123');
      expect(viaLocal).to.be.instanceof(Object);
  ...
  it('should require host', () => {
    expect(function () {
      let viaLocal = new iRobotSDK('myuser', 'mypassword');
      expect(viaLocal).to.be.instanceof(Object);
    }).to.throw(/host is required./);
  });

  it('should return an object', () => {
    let viaLocal = new iRobotSDK('myuser', 'mypassword', '192.168.1.104');
    expect(viaLocal).to.be.instanceof(Object);
  });
});
...
describe('dorita980 local call', () => {
  it('should be rejected if get an invalid json response', () => {
    let viaLocal = new iRobotSDK('myuser', '123456_bad', '192.168.1.104');
  ...
  it('should send getPreferences command with default decoded arg', () => {
    let viaLocal = new iRobotSDK('myuser', '123456_getprefs', '192.168.1.104');
  ...
  it('should send getPreferences command with default decoded arg and handle not ok response', () => {
    let viaLocal = new iRobotSDK('myuser', '123456_getprefs_err', '192.168.1.104');
  ...
  it('should send getMission command with default decoded arg', () => {
    let viaLocal = new iRobotSDK('myuser', '123456_getmission', '192.168.1.104');
  ...
  it('should send getMission command with default decoded arg and handle not ok response', () => {
    let viaLocal = new iRobotSDK('myuser', '123456_getmission_err', '192.168.1.104');
